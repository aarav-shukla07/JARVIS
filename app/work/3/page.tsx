    ...
    return (
        <div className="bg-[#00052a] text-white min-h-screen w-full">
            ...
            <div className={`${jetbrainsMono.className} text-center px-6 md:px-20 mt-20 mb-16`}>
                <p className="text-sm text-gray-400 tracking-widest uppercase mb-3">PROJECT</p>
                <h1 className="text-5xl md:text-7xl font-bold tracking-widest leading-[1.2]">
                    DEEPFAKE<br /> DETECTION <br /> SUITE
                </h1>
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-8 px-6 md:px-20">
                <div className="relative w-full md:w-1/2 h-[400px] md:h-[400px] rounded-xl overflow-hidden">
                    <Image src="/future/future3.avif" alt="Phobia Image 1" fill className="object-cover" />
                </div>
                <div className="relative w-full md:w-1/2 h-[400px] md:h-[400px] rounded-xl overflow-hidden">
                    <Image src="/future/future3-hover.avif" alt="Phobia Image 2" fill className="object-cover" />
                </div>
            </div>
            ...
            <div className={`${jetbrainsMono.className} text-center mt-20 mb-12 px-6 md:px-20`}>
                <div className="flex flex-col md:flex-row justify-center gap-16 text-sm uppercase text-gray-400 tracking-widest">
                    <div>
                        <p>Industry</p>
                        <p className="mt-2 text-white tracking-normal font-mono">CYBERSECURITY</p>
                    </div>
                    <div>
                        <p>Year</p>
                    ...
                    <div>
                        <p>Client</p>
                        <p className="mt-2 text-white tracking-normal font-mono">EXPERIMENTAL <br />CONCEPT</p>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 px-6 md:px-20 pb-24">
                <div className="relative w-full h-[900px] rounded-lg overflow-hidden md:col-span-2">
                    <Image src="/image2.webp" alt="Extra Image 3" fill className="object-cover" />
                </div>
                <div className="relative w-full h-[450px] rounded-lg overflow-hidden">
                    <Image src="/image3.webp" alt="Extra Image 1" fill className="object-cover" />
                </div>
                <div className="relative w-full h-[450px] rounded-lg overflow-hidden">
                    <Image src="/image4.webp" alt="Extra Image 2" fill className="object-cover" />
                </div>
                <div className="relative w-full h-[900px] rounded-lg overflow-hidden md:col-span-2">
                    <Image src="/image1.webp" alt="Extra Image 3" fill className="object-cover" />
                </div>
            </div>
                ...
                <div className="flex flex-col md:flex-row justify-center gap-12">
                    ...
                    <Link href="/work/4">
                        <div className="inline-block text-center hover:scale-105 transition-transform duration-300">
                            ...
                            <p className="font-mono text-sm tracking-wide">AI NPC EMOTION ENGINE</p>
                        </div>
                    </Link>
                </div>
            </div>
